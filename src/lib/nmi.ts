 ...
 *                                 customer's receipt. Default "ANGLER ASSISTANT".
 *   NMI_ENABLE_CUSTOMER_VAULT     "true" to store cards in NMI's Customer
 *                                 Vault on successful checkout. OFF by default.
 */
...
export const NMI_DESCRIPTOR = process.env.NMI_DESCRIPTOR ?? "ANGLER ASSISTANT";
...
export interface ChargeRequest {
  /** CAD amount, computed server-side from the province catalogue. */
  amount: number;
